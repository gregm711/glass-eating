  ...
  return (
    <Disclosure as="div" className="relative">
      {({ open }) => (
        <>
          <Disclosure.Button
            className={`default-transition font-normal pl-3 pr-2 py-2.5 ring-1 ring-fgd-3  text-fgd-1 text-sm hover:bg-bkg-3 focus:outline-none`}
          >
            {filters.length > 0 ? (
          ...
          <Disclosure.Panel
            className={`bg-bkg-1 border border-fgd-4 mt-2 p-4 absolute right-0 w-56 z-20  text-xs`}
          >
            <div>
